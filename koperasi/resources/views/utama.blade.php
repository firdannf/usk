...
<body>
    ...
    justify-content-between">
            <div class="logo">
                    ...
                    <a href=" index.html"><img src="assets/img/tamsis.png" alt="" class="img-fluid"></a>
                
                <h1 style="font-style: italic"><a href="index.html">Taman<span style="color: rgb(0, 93, 0)">Siswa</span>2 </a> </h1> <!-- Uncomment below if
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
                    <img src="assets/img/tamsis.png" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
                        ...
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <div class="portfolio-links">
                                    <a href="assets/img/{{$p->foto}}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="{{$p->nama}}"><i class="bx bx-plus"></i>SHOW</a>
                                    |
                                    @if(Auth::check())
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body clearfix">
                                    <div class="card" style="width: 18rem;">
                                        <img src="assets/img/{{$p->foto}}" class="card-img-top" alt="{{$p->nama}}">
                                        <div class="card-body">
                                            <h5 class="card-title">Deskripsi :</h5>
                                            <p class="card-text">kode : {{$p->kode}}</p>
                                            <p class="card-text">Name : {{$p->nama}}</p>
    ...
    <a href="#" class="back-to-top d-flex align-items-center justify-content-center" style="background-color: rgb(0, 90, 0)"><i class="bi bi-arrow-up-short"></i></a>
