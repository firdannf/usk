                        ...
                        <form action="/user/storeupdate" method="post" class="form-floating">
                            ...
                            <div class="form-floating p-1">
                                <select name="role" class="form-control">
                                    <option value="admin" @if($p->role =='toko') selected="selected" @endif>kantin</option>
                                    <option value="admin" @if($p->role =='siswa') selected="selected" @endif>Siswa</option>
                                </select>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/user/storeinput" method="post" class="form-floating">
                    ...
                    <div class="form-floating p-1">
                        <select name="role" class="form-control">
                            <option value="toko">kantin</option>
